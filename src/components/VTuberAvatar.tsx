  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Step 1: Backdrop */}
        <g data-avatar-background="true">{getBackgroundContent()}</g>
        ...
        >
          ...
          {effectiveEmotion === 'cry' && (
            <g opacity="0.95">
              ...
              <path
                d="M149 230 L151 235 L149 242 L147 235 Z"
                fill="#93c5fd"
          ...
          {effectiveEmotion === 'relaxed' && (
            <g opacity="0.95">
              ...
              <g className="animate-[pulse_2.5s_infinite_0.5s]">
                ...
                <path
                  d="M 310 180 C 305 172, 295 175, 300 185 C 305 195, 315 192, 310 180"
                  fill="#fda4af"
                  opacity="0.75"
                />
              </g>
          ...
          {effectiveEmotion === 'squint' && (
            <g opacity="0.9">
              ...
              <path
                d="M 110 80 Q 100 70 110 60 Q 120 70 110 80"
                fill="#f1f5f9"
        ...
        {artStyle === 'anime' && (
          <g id="anime-sparkles" pointerEvents="none">
            {/* Sparkle 1 */}
            <path
              d="M 120 70 Q 120 80 130 80 Q 120 80 120 90 Q 120 80 110 80 Q 120 80 120 70 Z"
              fill="#ffffff"
              opacity="0.65"
            />
            {/* Sparkle 2 */}
            <path
              d="M 280 65 Q 280 75 290 75 Q 280 75 280 85 Q 280 75 270 75 Q 280 75 280 65 Z"
              fill="#ec4899"
              opacity="0.75"
            />
            {/* Sparkle 3 (Yellow glowing star) */}
            <path
              d="M 85 190 Q 85 196 91 196 Q 85 196 85 202 Q 85 196 79 196 Q 85 196 85 190 Z"
              fill="#facc15"
              opacity="0.7"
            />
            <path
              d="M 315 210 Q 315 216 321 216 Q 315 216 315 222 Q 315 216 309 216 Q 315 216 315 210 Z"
              fill="#60a5fa"
              opacity="0.65"
            />
          </g>
