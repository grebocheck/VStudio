  ...
  return (
    <>
      {emotion === 'love' && (
        <g>
          <defs>
            <radialGradient id={svgId('love-flush-grad')} cx="50%" cy="45%" r="55%">
          ...
          <ellipse
            ...
            rx="70"
            ry="80"
            fill={svgUrl('url(#love-flush-grad)')}
      ...
      {emotion === 'angry' && (
        <g>
          <defs>
            <radialGradient id={svgId('angry-flush-grad')} cx="50%" cy="45%" r="55%">
          ...
          <ellipse
            ...
            rx="70"
            ry="80"
            fill={svgUrl('url(#angry-flush-grad)')}
