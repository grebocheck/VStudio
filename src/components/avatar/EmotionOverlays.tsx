    ...
    <>
      {emotion === 'angry' && (
        <g opacity="0.95">
          ...
          />
          <defs>
            <linearGradient id={svgId('angry-forehead-gloom')} x1="0" y1="0" x2="0" y2="1">
          ...
          <rect x="120" y="85" width="160" height="75" fill={svgUrl('url(#angry-forehead-gloom)')} rx="12" />
        </g>
      )}
      ...
      {emotion === 'depressed' && (
        <g opacity="0.95">
          <defs>
            <linearGradient id={svgId('forehead-gloom')} x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#4f46e5" stopOpacity="0.6" />
              <stop offset="45%" stopColor="#312e81" stopOpacity="0.45" />
              <stop offset="100%" stopColor="#312e81" stopOpacity="0.0" />
            </linearGradient>
          </defs>
          <rect x="125" y="80" width="150" height="70" fill={svgUrl('url(#forehead-gloom)')} rx="10" />
          <path
      ...
      {emotion === 'cool' && (
        <g opacity="0.95">
          <defs>
            <clipPath id={svgId('cool-shades-clip')}>
          ...
          <path
            ...
            fill={svgUrl('url(#cool-lens-grad)')}
            opacity="0.88"
            stroke="#1e293b"
            strokeWidth="3.5"
          />
          ...
          <g clipPath={svgUrl('url(#cool-shades-clip)')}>
            <line
              x1="110"
              y1="140"
              x2="190"
